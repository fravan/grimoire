...
function button2(text3, on_click_msg) {
  return button(
    toList([
      ...
      class$(
        "bg-red-600 text-white text-semibold rounded-lg hover:bg-red-800 px-2 py-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
      )
    ]),
    toList([text2(text3)])
  );
